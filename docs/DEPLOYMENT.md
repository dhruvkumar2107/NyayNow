...
4. Your connection string is: `mongodb+srv://<username>:<password>@cluster0.iofqvq2.mongodb.net/nyaynow?retryWrites=true&w=majority`. (Note: The `@` in your password has been encoded to `%40` for URL compatibility).
...
7. **Environment Variables** (Add these in Render):
   - `MONGO_URI`: `mongodb+srv://<username>:<password>@cluster0.iofqvq2.mongodb.net/nyaynow?retryWrites=true&w=majority`
