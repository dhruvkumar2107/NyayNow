                    ...
                    <div className="bg-[#030712] border border-white/10 rounded-3xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-3xl relative overflow-hidden">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h3 className="text-white font-bold text-sm mb-1">Privacy & Consent</h3>
                                <p className="text-slate-400 text-[11px] leading-relaxed">
                                     We use cookies to enhance your experience. Your data is fully secured in India and <span className="text-white font-bold">never used for AI training</span>. Read our <a href="/privacy" className="text-blue-500 hover:underline">Privacy Policy</a> and <a href="/dpdp" className="text-blue-500 hover:underline">DPDP Compliance</a>.
                                </p>
                            </div>
