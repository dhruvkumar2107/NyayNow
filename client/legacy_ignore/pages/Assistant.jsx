      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col relative bg-[url('https://grainy-gradients.vercel.app/noise.svg')] bg-opacity-5">
          ...
          <header className="h-16 border-b border-white/5 flex items-center justify-between px-6 bg-midnight-900/80 backdrop-blur-md z-10 sticky top-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400">Powered by NyayAI</p>
              </div>
            </div>
          ...
          <div className="p-6 pb-8 max-w-4xl mx-auto w-full">
            ...
            {messages.length <= 1 && (
              <div className="mb-4">
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 px-1">Suggested Inquiries</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    "What are my rights if arrested?",
                    "Explain FIR procedure under BNSS 2023",
                    "Draft a rental agreement clause"
                  ].map((chip) => (
                    <button
                      key={chip}
                      type="button"
            ...
            {/* Watermark notice */}
            <p className="text-center text-[10px] text-slate-600 mt-3 flex flex-col gap-1.5 items-center justify-center uppercase tracking-wider font-bold">
              <span>NyayNow AI can make mistakes. Always review generated documents with an advocate.</span>
              <span className="text-[8px] text-slate-500 font-normal tracking-wide normal-case">Powered by fine-tuned Llama-3-70B-Instruct & Gemini-1.5-Flash models.</span>
            </p>
          </div>
