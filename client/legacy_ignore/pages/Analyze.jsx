  ...
  return (
    <div className="min-h-screen bg-[#020617] font-sans text-slate-400 selection:bg-indigo-500/30">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mt-8 space-y-6">
              ...
              <div className="flex items-center gap-3 px-5 py-4 bg-emerald-500/5 border border-emerald-500/20 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Powered by NyayAI • Based on Indian Law</p>
                </div>
                <button
        ...
        <p className="text-center text-[10px] text-slate-600 mt-12 flex flex-col gap-1.5 items-center justify-center uppercase tracking-wider font-bold">
          <span>NyayNow AI can make mistakes. Always review generated analysis with an advocate.</span>
