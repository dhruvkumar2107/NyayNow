...
const JudgeAI = () => {
    ...
    const generatePDF = () => {
        ...
        doc.text("Generated by NyayNow AI Justice Engine. This is an AI prediction, legal information only.", 105, pageHeight - 10, { align: 'center' });
                            ...
                            <div className="mb-6 p-4 rounded-2xl bg-amber-500/5 border border-amber-500/10 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-500 leading-relaxed">
                                        The win probability and strategy provided are generated by an AI model based on historical data. This is <span className="text-white underline">NOT</span> a guarantee of a court outcome nor is it professional legal counsel. Courts are unpredictable; always consult a registered advocate for final strategy.
                                    </p>
                                </div>
                            </div>
